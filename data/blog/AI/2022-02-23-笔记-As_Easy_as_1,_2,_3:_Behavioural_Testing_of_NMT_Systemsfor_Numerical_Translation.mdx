...
![](https://www.tzer.top/usr/uploads/2022/02/2175163016.png)
...
![四种主要错误类型](https://www.tzer.top/usr/uploads/2022/02/1907647207.png)
...
![](https://www.tzer.top/usr/uploads/2022/02/3698849764.png)

收集带有数字的句子，然后将数字地方用[NUM]替换，根据生成的不同数字文本替换 [NUM]。

![](https://www.tzer.top/usr/uploads/2022/02/1605931881.png)
