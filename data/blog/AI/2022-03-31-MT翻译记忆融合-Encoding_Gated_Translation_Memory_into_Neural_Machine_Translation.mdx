...
![](https://www.tzer.top/usr/uploads/2022/03/889268367.png)

在输入和TM匹配时，作者采用如下公式fuzzy match score（FMS）：

![](https://www.tzer.top/usr/uploads/2022/03/3823838402.png)

验证了不同的FMS对结果的影响：

![](https://www.tzer.top/usr/uploads/2022/03/3549224305.png)
