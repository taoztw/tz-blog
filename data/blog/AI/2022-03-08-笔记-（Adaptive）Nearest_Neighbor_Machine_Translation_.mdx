...
![](https://www.tzer.top/usr/uploads/2022/03/2007333394.png)
...
![](https://www.tzer.top/usr/uploads/2022/03/1936347486.png)

## KNN概率分布的计算方式

![](https://www.tzer.top/usr/uploads/2022/03/1279056054.png)
...
![](https://www.tzer.top/usr/uploads/2022/03/726049670.png)
...
![](https://www.tzer.top/usr/uploads/2022/03/1864905435.png)
...
![](https://www.tzer.top/usr/uploads/2022/03/2324126970.png)
...
![](https://www.tzer.top/usr/uploads/2022/03/3370754496.png)
...
![](https://www.tzer.top/usr/uploads/2022/03/989383657.png)
...
![](https://www.tzer.top/usr/uploads/2022/03/4272766209.png)

![](https://www.tzer.top/usr/uploads/2022/03/3962600120.png)

## 案例

KNN示例检索不仅正确预测了target word，而且上下文都是语义相关的。

![](https://www.tzer.top/usr/uploads/2022/03/3467080491.png)

在模型可以访问非常少量的模棱两可的目标端上下文的示例中。KNN-MT能够依赖源上下文来解决此问题并生成正确的目标令牌，will

![](https://www.tzer.top/usr/uploads/2022/03/797282224.png)

KNN匹配局部的上下文，而不是全局，比如Papua

![](https://www.tzer.top/usr/uploads/2022/03/4132078010.png)
...
![](https://www.tzer.top/usr/uploads/2022/03/692906177.png)

上图看出，正确预测应为spreadsheet，但是table出现了很多次，导致KNN-MT最后结果是table。

meta-k网络实现：

![](https://www.tzer.top/usr/uploads/2022/03/2988224032.png)

d,c是距离和次数特征。$f_{Meta}()$是一个前向传播层，隐层大小32（使用2k sents 训练了Meta-k 5k steps）。

![](https://www.tzer.top/usr/uploads/2022/03/2000080115.png)

NMT模型和不同的KNN预测与Meta-k网络的输出进行聚合，得到最终的预测

![](https://www.tzer.top/usr/uploads/2022/03/2535489193.png)
